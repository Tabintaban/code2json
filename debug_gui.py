...
class AppGUI:
    ...
    def setup_ui(self):
        ...
        """
        print("DEBUG: Начало настройки UI")
        ...
        print(f"DEBUG: Состояние левого текстового поля: {self.input_text.cget('state')}")
        ...
        print(f"DEBUG: Состояние правого текстового поля: {self.output_text.cget('state')}")
        ...
        print("DEBUG: Завершена настройка UI")
